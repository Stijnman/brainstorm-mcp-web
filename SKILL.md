...
**Description**: Repository for brainstorm-mcp-web - [Brief description to be added]
...
|-----------|-----------------|
| Bug Report | Open a [GitHub Issue](https://github.com/Stijnman/brainstorm-mcp-web/issues) |
| Security Issue | Email: security@stijnman.com |
| General Question | Open a [GitHub Discussion](https://github.com/Stijnman/brainstorm-mcp-web/discussions) |
